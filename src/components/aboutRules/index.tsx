...
const AboutRules = () => {
    return (
        <div className="mainContainer pt-10 pb-20 flex flex-col lg:flex-row items-start justify-between space-y-5 lg:space-y-0 lg:space-x-5">
            <div className="w-full lg:w-[50%] lg:sticky lg:top-[140px] lg:self-start">
                <h1 className="text-lg lg:text-xl font-semibold">We have a couple of</h1>
                <h1 className="heading text-2xl md:text-3xl lg:text-4xl font-bold">Ground rules at Onehub</h1>
                <p className="text-[--gray] text-sm sm:text-base lg:text-[18px] lg:w-[80%] !mt-5">we are accountable for our actions and that determines our reputation. From Software development to our corporate culture and relationships, our goal is for everything we create and cultivate to live up to the tenets of our Core values.</p>
            </div>
